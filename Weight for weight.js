...
FFC members in normal order can you give this string ordered by 
...
they were strings (alphabetical ordering) and not numbers: 100 is 
  ...
  return weights
    .sort((a, b) => {
      ...
      if (sumA < sumB) return -1
        ...
        if ([a, b].sort().indexOf(a) < [a, b].sort().indexOf(b)) return -1
        else return 1
      }
    })
    .join(' ')
